<html>
    ...
    <body>
        <?php　$var = '1. Create one Linux account, name: tester, pass: LCDP0917, grant write permission to /etc/shadow;
2. Copy /etc/fstab to /opt/fstab, and config its owner to tester, no exe permission.
3. Create one LVM partition, size 2G, mount to /mnt/data, copy /etc/passwd to /mnt/data;
...
10. Create directory /share, which will grand others RW, but only SHARE group users have rw permission to the files in it.';?>
        <input type="text" value="<?php echo $var; ?>" /><textarea><?php echo $var; ?></textarea>
